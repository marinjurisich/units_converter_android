...
public class WeightConverterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fetch metric units
        String[] metricUnitsLabels = getResources().getStringArray(R.array.metric_units_weight_labels);
        // Fetch imperial units
        String[] imperialUnitsLabels = getResources().getStringArray(R.array.imperial_units_weight_labels);
    ...
    public void calculate(View view) {
        ...
        String[] metricUnitsLabels = getResources().getStringArray(R.array.metric_units_weight_labels);
        String[] metricUnitsValues = getResources().getStringArray(R.array.metric_units_weight_values);
        ...
        String[] imperialUnitsLabels = getResources().getStringArray(R.array.imperial_units_weight_labels);
        String[] imperialUnitsValues = getResources().getStringArray(R.array.imperial_units_weight_values);
